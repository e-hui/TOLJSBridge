#
#  Be sure to run `pod spec lint TOLJSBridge.podspec' to ensure this is a
...
A JSBridge for iOS hybrid, which implement by Objective-C.
                   DESC

  spec.homepage     = "https://github.com/MrTongHui/TOLJSBridge"
  ...
  spec.author             = { "@hui" => "873307240@qq.com" }
  # Or just: spec.author    = "@hui"
  # spec.authors            = { "@hui" => "873307240@qq.com" }
